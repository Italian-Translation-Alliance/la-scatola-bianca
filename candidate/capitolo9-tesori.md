...
Calcola la percentuale totale del tesoro che può essere scambiato e tira un d100 per vedere se puoi tirare per un oggetto su una delle seguenti tabelle. Si suggerisce che l'arbitro inizi con i valori da 5.000 po e scenda fino ai valori da 100 po. "Gioielli" si riferisce ad un singolo oggetto di gioielleria.

Ricorda sempre che queste tabelle sono solo linee guida - se desideri il posizionamento di un particolare oggetto o tipo di tesoro, fallo pure! Se non vuoi includere gemme, gioielli o oggetti magici, allora lascia che il tesoro sia di sole monete. Queste tabelle sono qui solo per aiutare.

### Scambio di Tesori (Esempio \#1)

Se popoli un'area con 5 scheletri, il loro valore PE totale sarebbe 75. Se tu tirassi sulla tabella dei valori del tesoro e ottenessi un 4, il valore totale del tesoro per quell'incontro è 225 po e la ripartizione sarebbe (arrotondata per difetto): 112 po, 900 pa e 2.250 pr. C'è il 10% di possibilità di scambiare 100 po di quel tesoro con un oggetto minore. Se, con un d100, tiri meno del 10%, allora il valore del tesoro di quell'incontro sarebbe di 12 po, 900 pa, 2.250 pr e un oggetto minore (tirato sulla tabella Gemme/Gioielli minori o Magia minore).

### Scambio di Tesori (Esempio \#2)

Piazzi un temibile minotauro in una stanza chiusa del dungeon per un totale di 400 PE. Tirando contro la tabella dei valori del tesoro, se tu tirassi un 6, il valore totale del tesoro per questo incontro è di 1.600 po e la ripartizione sarebbe: 1.200 po e 4.000 pa. C'è il 10% di possibilità di scambiare 1.000 po di quel tesoro con un oggetto medio. Se, su un d100, tiri meno del 10%, allora il valore del tesoro in quell'incontro sarebbe di 200 po, 4.000 pa e un oggetto medio (tirato sulla tabella Gemme/Gioielli medi o Magia media). Con il restante valore totale in oro, ci potrebbe essere una possibilità del 60% di scambiare 600 po per un oggetto minore, sei possibilità del 10% di scambiare 600 po per un totale di sei oggetti minori, o qualche altra variante come una possibilità del 10% di scambiare 100 po per un oggetto minore (mantenendo i restanti 500 po).

### Scambio per 5.000 po 
...
| Tiro | **Risultato**                                                     |
|------|-------------------------------------------------------------------|
| 1    | Tira 6 volte sulla tabella delle Pozioni                          |
| 2-3  | Tira 1d6+12 sulla tabella delle Pergamene                         |
| 4-5  | Tira 1d6+12 sulla tabella delle Armi e Armature                   |
| 6    | Tira 1d20+40 sulla tabella delle Varie (include Anelli e Bastoni) |

#### Scambio per 1,000 po
...
| Tiro | **Risultato**                                                     |
|------|-------------------------------------------------------------------|
| 1    | Tira 3 volte sulla tabella delle Pozioni                          |
| 2-3  | Tira 1d6+6 sulla tabella delle Pergamene                          |
| 4-5  | Tira 1d6+6 sulla tabella delle Armi e Armature                    |
| 6    | Tira 1d20+20 sulla tabella delle Varie (include Anelli e Bastoni) |

### Scambio per 100 po

Un lancio di 1-19 su un d20 significa un lancio sulla tabella delle Gemme/Gioielli Minori. Un lancio di 20 risulta in un lancio sulla tabella degli Oggetti Magici Minori.
...
| Tiro | **Risultato**                                                  |
|------|----------------------------------------------------------------|
| 1    | Tira una volta sulla tabella delle Pozioni                     |
| 2-3  | Tira 1d6 sulla tabella delle Pergamene                         |
| 4-5  | Tira 1d6 sulla tabella delle Armi e Armature                   |
| 6    | Tira 1d20 sulla tabella delle Varie (include Anelli e Bastoni) |
...
**Calamita**: Risultati come da incantesimo.

**Controllo degli animali**: Risultati come per l'incantesimo Incanto Mostro.

**Controllo del drago**: 1d3 draghi di un tipo specifico (determinato a caso dall'Arbitro) sono influenzati come da incantesimo Incanto Mostro.

**Controllo dei non morti**: 2d4 non-morti con meno di 4 DV e 1d4 non-morti con 4+ dadi vita cadono sotto il controllo di chi beve come da incantesimo Incanta Mostro.

**Controllo delle piante**: Risultati come da incantesimo Incanto Mostro.
...
**Etericità**: Chi beve questa pozione può muoversi attraverso gli oggetti solidi ma non può attaccare. Anche l'equipaggiamento diventa etereo.
...
**Guarigione**: Cura 1d6+1 HP di danni.

**Guarigione extra**: Cura 3d6+3 HP di danni.

**Invisibilità**: Risultati come da incantesimo.

**Invulnerabilità**: +2 ai tiri salvezza, gli avversari attaccano a -2.

**Levitazione**: Risultati come da incantesimo.
...
**Schiavitù**: Risultati come da incantesimo.
...
| 17   | +3 Scudo                               |
| 18   | +3 Armatura                            |
| 19   | Arma insolita (opzionale) o Riavvolgi  |
...
\* Non può essere steso senza l'aiuto dell'incantesimo Remove Curse
...
| 1     | Bacchetta Minore           |
| 2     | Anello Minore              |
| 3-20  | Var. Oggetto Magico Minore |
| 21    | Bacchetta Minore           |
| 22    | Bacchetta Minore           |
...
| 25    | Anello Minore              |
| 26    | Anello Maggiore            |
| 27-40 | Var. Oggetto Magico Medio  |
| 41    | Bacchetta Grande           |
| 42    | Bacchetta Grande           |
| 43    | Anello Maggiore            |
| 44    | Anello Maggiore            |
| 45    | Bastone                    |
| 46-60 | Var. Grande Oggetto Magico |
...
**Bacchetta d'individuazione (magia)**: Funziona come un incantesimo d'individuazione del magico con una portata di 6 metri. L'utilizzatore della bacchetta ottiene una vaga percezione del tipo di magia che viene individuata. Sempre attiva quando viene tenuta in mano, non usa cariche.
...
**Bacchetta del Polimorfo**: Lancia Polimorfo (se stesso) o Polimorfo (altri), porta 10 cariche.
